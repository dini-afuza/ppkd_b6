...
part of 'got_houses.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GotHouses _$GotHousesFromJson(Map<String, dynamic> json) => GotHouses(
...
Map<String, dynamic> _$GotHousesToJson(GotHouses instance) => <String, dynamic>{
  'url': instance.url,
  'name': instance.name,
